        ...
        <div>
            ...
            <div class="relative">
                <input type="password" name="current_password" id="profile_current_password" autocomplete="current-password"
                       class="w-full border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl px-4 py-3 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 @error('current_password', 'updatePassword') border-red-400 @enderror">
                <button type="button" onclick="togglePassword('profile_current_password', this)"
                    class="password-toggle absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
        ...
        <div>
            ...
            <div class="relative">
                <input type="password" name="password" id="profile_password" autocomplete="new-password"
                       class="w-full border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl px-4 py-3 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 @error('password', 'updatePassword') border-red-400 @enderror">
