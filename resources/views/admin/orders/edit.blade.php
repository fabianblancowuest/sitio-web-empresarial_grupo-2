...
<div class="mb-8">
    ...
    <h1 class="font-display text-2xl font-extrabold text-ink dark:text-white">Editar pedido</h1>
...
<div class="max-w-2xl">
    <form action="{{ route('admin.orders.update', $order) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 space-y-5">
            <h2 class="font-display font-bold text-sm uppercase tracking-wide text-slate-400">Datos del proyecto</h2>
            ...
            <div>
                ...
                <select name="user_id" class="w-full border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none">{{ old('description', $order->description) }}</textarea>
            </div>
        </div>
