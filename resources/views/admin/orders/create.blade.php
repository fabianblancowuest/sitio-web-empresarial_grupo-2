...
<div class="mb-8">
    ...
    <h1 class="font-display text-xl sm:text-2xl font-bold text-ink dark:text-white">Nuevo pedido</h1>
...
<div class="max-w-2xl">
    <form action="{{ route('admin.orders.store') }}" method="POST" class="space-y-5">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 sm:p-6 space-y-5">
            <h2 class="font-display font-bold text-ink dark:text-white text-xs uppercase tracking-wide text-slate-400">Datos del proyecto</h2>
            ...
            <div>
                ...
                <select name="user_id" class="w-full border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 @error('user_id') border-red-400 @enderror">
            ...
            <div>
                ...
                <textarea name="description" rows="3" placeholder="Detalles del proyecto..."
                          class="w-full border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none">{{ old('description') }}</textarea>
            </div>
        </div>
