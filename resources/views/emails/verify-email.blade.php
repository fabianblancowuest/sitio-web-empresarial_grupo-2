...
<head>
    ...
    <title>Verificá tu correo · CodeBridge</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.05), 0 4px 6px -4px rgba(0, 0, 0, 0.05);">
                    ...
                    <tr>
                        <td style="background-color: #4f6ef7; padding: 32px; text-align: center;">
                            ...
                            <p style="margin: 8px 0 0 0; font-size: 14px; color: #dde6ff; font-weight: 500;">Verificación de correo electrónico</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 32px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #334155;">
                                Gracias por registrarte en <strong>CodeBridge</strong>. Para empezar a usar tu cuenta, necesitamos que verifiques tu dirección de correo electrónico haciendo clic en el botón de abajo.
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 32px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $verificationUrl }}" style="display: inline-block; background-color: #4f6ef7; color: #ffffff; font-family: 'Syne', sans-serif; font-size: 16px; font-weight: 700; text-decoration: none; padding: 14px 40px; border-radius: 12px; letter-spacing: 0.3px;">
                                            Verificar correo
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 1.6; color: #64748b;">
                                Si no creaste una cuenta en CodeBridge, podés ignorar este mensaje.
                            </p>
                            <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #64748b;">
                                El enlace de verificación expira en <strong>60 minutos</strong>.
                            </p>
                        </td>
                    </tr>
